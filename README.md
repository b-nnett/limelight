...
See [Installation](docs/INSTALLATION.md) for local development installs, signing, and LaunchAgent setup.
...
- [Installation](docs/INSTALLATION.md): DMG install, local app install, signing, and LaunchAgent.
- [Providers](docs/PROVIDERS.md): searchable sources, permissions, readiness, and limitations.
- [API Reference](docs/API.md): endpoints, request examples, toolbox endpoints, and origin headers.
- [Capability Matrix](docs/CAPABILITY_MATRIX.md): generated local runtime provider capability snapshot.
