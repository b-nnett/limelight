...
Generated from `http://127.0.0.1:8765/v1/capabilities`.

| Source | Live Status | Permission | Entity Types | Supported Fields | Limitations |
| --- | --- | --- | --- | --- | --- |
...
| notes | ready | Full Disk Access for Notes private store. | note | entityType, id, matchReason, modifiedAt, noteID, source, subtitle, title | Does not expose full note bodies by default; rich attributed note decoding is partial. |
